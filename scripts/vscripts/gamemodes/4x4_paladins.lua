				...
				if playerCount ~= 0 then
					for i = 1, playerCount do
						if PlayerResource:GetNthPlayerIDOnTeam(team, i) == event.PlayerID then
							...
							GameMode:spawnCreep(event.name, 1, Entities:FindByName( nil, "spawn_" .. team .. "_" .. i):GetAbsOrigin(), Entities:FindByName( nil, "point_" .. team .. "_start" .. t_point), team, hero)		
						end
					end
				end
			else
								...
								if playerCount ~= 0 then
									for i = 1, playerCount do
										if PlayerResource:GetNthPlayerIDOnTeam(team, i) == ownerid then
											...
											if i == 1 or i == 2 then t_point = "_1-3"
											elseif i == 3 or i == 4 then t_point = "_2-4" end
											GameMode:spawnCreep(unit.name, 1, Entities:FindByName( nil, "spawn_" .. team .. "_" .. i):GetAbsOrigin(), Entities:FindByName( nil, "point_" .. team .. "_start" .. t_point), team, hero)
										end
									end
								end
